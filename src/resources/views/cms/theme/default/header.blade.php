    ...
    <div class="flex items-center justify-between py-6 lg:py-10">
        ...
        <div class="lg:hidden">
            <div class="flex items-center">
                <i class="bx mr-8 cursor-pointer text-3xl text-primary dark:text-white bxs-sun" 
                    @click="$store.theme.toggleTheme()"
                    x-bind:class="$store.theme.isDarkMode() ? 'bxs-sun' : 'bxs-moon'"
                ></i>

                <svg width="24" height="15" xmlns="http://www.w3.org/2000/svg" 
                    @click="isMobileMenuOpen = true"
                    class="cursor-pointer fill-current text-primary dark:text-white"
                >
                    <g fill-rule="evenodd">
                ...
                <div x-show="isMobileMenuOpen" class="flex justify-center text-primary " x-cloak>
                    <div class="z-1 absolute flex h-screen right-0 top-0"  @click.away="isMobileMenuOpen = false">
        ...
        <div class="hidden lg:block">
            <ul class="flex items-center">
                ...
                <li class="group relative mr-6 mb-1">
                    <a href="#" @click="$store.theme.toggleTheme()" class="inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold shadow-sm hover:bg-gray-400">
